...
// Clase que representa un Factura con Id y Total
...
public class ArbolB
{
    ...
    {
        Factura nuevoFactura = new Factura(id, total);
...
*/
       ...
       */
        ...
        // Mostrar Facturas en orden
        Console.WriteLine("\nRecorrido InOrden del árbol:");
        arbol.RecorridoInOrden().ForEach(elem => 
            Console.WriteLine($"Id: {elem.Id}, Total: {elem.Total}"));
